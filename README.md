About better_exceptions_fork-feedstock
======================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/better_exceptions_fork-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6100&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/better_exceptions_fork-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `better_exceptions_fork` can be installed with `conda`:
...
```
mamba install better_exceptions_fork
```

It is possible to list all of the versions of `better_exceptions_fork` available on your platform with `conda`:
...
```
mamba search better_exceptions_fork --channel conda-forge
```
...
mamba repoquery search better_exceptions_fork --channel conda-forge

# List packages depending on `better_exceptions_fork`:
mamba repoquery whoneeds better_exceptions_fork --channel conda-forge

# List dependencies of `better_exceptions_fork`:
mamba repoquery depends better_exceptions_fork --channel conda-forge
```
